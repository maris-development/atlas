...
Re-run after `bench_collection.py` produces new numbers:
    ...
    python pyatlas/benchmarks/generate_bench_charts.py
"""
...
# Repo layout: pyatlas/benchmarks/generate_bench_charts.py → docs/assets/
...
# Numbers from the sweep recorded in pyatlas/docs/benchmarks.md.
