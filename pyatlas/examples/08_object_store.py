...
Install (once):
    ...
    pip install "pyatlas[cloud]"   # pulls obstore alongside pyatlas

Run:

    python pyatlas/examples/08_object_store.py
...
def main() -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        with pyatlas.Atlas.create(store, codec="zstd") as atlas:
            ...
            atlas.add_xr_dataset(ds, "feb_2024")
        # `with` exit calls atlas.close() == single flush. On a cloud
