...
See [`examples/05_codecs.py`](https://github.com/robinskil/atlas/blob/main/pyatlas/examples/05_codecs.py)
...
[`examples/04_meta_formats.py`](https://github.com/robinskil/atlas/blob/main/pyatlas/examples/04_meta_formats.py)
...
atlas = pyatlas.Atlas.open("/tmp/store")
```
